...
public class LoaderUtility {
	...
	@ManagedOperationParameters( { @ManagedOperationParameter(description = "Category Id", name = "categoryId"), @ManagedOperationParameter(description = "File path", name = "filepath") })
	...
	@ManagedOperationParameters( { @ManagedOperationParameter(description = "Thread Id", name = "threadId"), @ManagedOperationParameter(description = "File path", name = "filepath") })
