...
/**
 * This produces a list of posts for the thread being viewed.
 * 
 * @author dseymore
 * 
 */
...
public class ViewThreadController extends SimpleFormController {
	...
	protected ModelAndView showForm(HttpServletRequest arg0, HttpServletResponse httpServletResponse, BindException e, Map map) throws Exception {
		...
		if (t != null) {
			...
			// ok, lets walk through the posts, and handle the special html for
			// linking between posts.. TODO - make this a better
			// implementation..
